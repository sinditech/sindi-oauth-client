...
//		System.out.println(response.getStatusCode());
		...
		Builder builder = new Builder("https://oauth2.googleapis.com/token", "4/0AfJohXnEuhC_I7QuJ5jvhhPKOqgOjsjOgK5huITa0-BXe2CrxfBx3kuuRagxwu90IR9Kpw", "https://developers.google.com/oauthplayground/");
		...
		oauthClient.setClientAuthentication(new ClientParametersAuthentication("407408718192.apps.googleusercontent.com", null));
