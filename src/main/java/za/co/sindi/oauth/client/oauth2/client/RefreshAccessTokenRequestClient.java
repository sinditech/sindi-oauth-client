 ...
 */
public class RefreshAccessTokenRequestClient extends AbstractOAuth2TokenRequestClient<RefreshAccessTokenRequest, AccessTokenResponse> {

	@Override
	public HttpRequest createHttpRequest(RefreshAccessTokenRequest request) {
