 ...
 */
public class AuthorizationCodeAccessTokenRequestClient extends AbstractOAuth2TokenRequestClient<AuthorizationCodeAccessTokenRequest, AccessTokenResponse> {

	@Override
	public HttpRequest createHttpRequest(AuthorizationCodeAccessTokenRequest request) {
